...
public class BlockRedstoneTorch extends BlockTorch {
	...
	public int getBlockTextureFromSideAndMetadata(int i1, int i2) {
		return i1 == 1 ? 
				Block.redstoneWire.getBlockTextureFromSideAndMetadata(i1, i2) 
			: 
				super.getBlockTextureFromSideAndMetadata(i1, i2);
	}
	...
	private boolean isIndirectlyPowered(World world1, int i2, int i3, int i4) {
		...
		return 
				i5 == 5 && world1.isBlockIndirectlyProvidingPowerTo(i2, i3 - 1, i4, 0) ? true : 
					(i5 == 3 && world1.isBlockIndirectlyProvidingPowerTo(i2, i3, i4 - 1, 2) ? true : 
						(i5 == 4 && world1.isBlockIndirectlyProvidingPowerTo(i2, i3, i4 + 1, 3) ? true : 
							(i5 == 1 && world1.isBlockIndirectlyProvidingPowerTo(i2 - 1, i3, i4, 4) ? true : 
								i5 == 2 && world1.isBlockIndirectlyProvidingPowerTo(i2 + 1, i3, i4, 5))));
	}
