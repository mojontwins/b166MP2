...
public class ThreadLoginVerifier extends Thread {
	...
	public ThreadLoginVerifier(NetLoginHandler netLoginHandler1, Packet1Login packet1Login2) {
	...
	public void run() {
		try {
			...
			URL uRL2 = new URL("http://session.minecraft.net/game/checkserver.jsp?user=" + URLEncoder.encode(this.loginPacket.username, "UTF-8") + "&serverId=" + URLEncoder.encode(string1, "UTF-8"));
