...
class ThreadDownloadImage extends Thread {
	...
	final HttpTextureProcessor buffer;
	final ThreadDownloadImageData imageData;

	ThreadDownloadImage(ThreadDownloadImageData threadDownloadImageData1, String string2, HttpTextureProcessor imageBuffer3) {
	...
	public void run() {
		...
		try {
			...
			if(this.buffer == null) {
				...
				this.imageData.image = this.buffer.process(ImageIO.read(httpURLConnection1.getInputStream()));
			}
