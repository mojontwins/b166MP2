...
public abstract class Render {
	...
	protected void loadTexture(String string1) {
		...
		if(renderEngine2 != null) renderEngine2.bindTexture(renderEngine2.getTexture(string1));
	}
	...
	private void renderEntityOnFire(Entity entity1, double d2, double d4, double d6, float f8) {
		...
		*/
		...
		while(f20 > 0.0F) {
			...
			tessellator17.addVertexWithUV((double)(f18 - f19), (double)(0.0F - f21), (double)f22, f13, f15);
			tessellator17.addVertexWithUV((double)(-f18 - f19), (double)(0.0F - f21), (double)f22, f12, f15);
			tessellator17.addVertexWithUV((double)(-f18 - f19), (double)(1.4F - f21), (double)f22, f12, f14);
			tessellator17.addVertexWithUV((double)(f18 - f19), (double)(1.4F - f21), (double)f22, f13, f14);
			f20 -= 0.45F;
			f21 -= 0.45F;
			f18 *= 0.9F;
			f22 += 0.03F;
	...
	public void doRenderShadowAndFire(Entity entity1, double d2, double d4, double d6, float f8, float f9) {
		if(GameSettingsValues.fancyGraphics && this.shadowSize > 0.0F) {
