...
public class RecipesDyes {
	public void addRecipes(CraftingManager craftingManager1) {
		for(int i2 = 0; i2 < 16; ++i2) {
			craftingManager1.addShapelessRecipe(new ItemStack((Block) Block.cloth, 1, ((IDyeableBlock)Block.cloth).getDyeFromMetadata(i2)), new Object[]{new ItemStack(Item.dyePowder, 1, i2), new ItemStack(Item.itemsList[Block.cloth.blockID], 1, 0)});
		}
