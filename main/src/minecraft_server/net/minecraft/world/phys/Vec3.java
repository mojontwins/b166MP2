...
public class Vec3 {
	...
	public Vec3 subtract(Vec3 par1Vec3) {
		return getVec3Pool().getVecFromPool(par1Vec3.xCoord - this.xCoord, par1Vec3.yCoord - this.yCoord,
				par1Vec3.zCoord - this.zCoord);
	}
	...
	public Vec3 normalize() {
		...
		return var1 < 1.0E-4D ? getVec3Pool().getVecFromPool(0.0D, 0.0D, 0.0D)
				: getVec3Pool().getVecFromPool(this.xCoord / var1, this.yCoord / var1, this.zCoord / var1);
	}
	...
	public Vec3 crossProduct(Vec3 par1Vec3) {
		return getVec3Pool().getVecFromPool(this.yCoord * par1Vec3.zCoord - this.zCoord * par1Vec3.yCoord,
	...
	public Vec3 getIntermediateWithXValue(Vec3 par1Vec3, double par2) {
		...
		if (var4 * var4 < 1.0000000116860974E-7D) {
			...
			return var10 >= 0.0D && var10 <= 1.0D
					? getVec3Pool().getVecFromPool(this.xCoord + var4 * var10, this.yCoord + var6 * var10,
