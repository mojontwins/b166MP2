...
public class AxisAlignedBB {
	...
	public static List<AxisAlignedBB> getBoundingBoxes() {
		return boundingBoxes;
	}

	public static void setBoundingBoxes(List<AxisAlignedBB> boundingBoxes) {
		AxisAlignedBB.boundingBoxes = boundingBoxes;
	}
