...
import net.minecraft.world.entity.item.EntityETNTPrimed;
import net.minecraft.world.entity.player.EntityPlayer;
import net.minecraft.world.item.Item;
import net.minecraft.world.level.World;
import net.minecraft.world.level.material.Material;

public class BlockETNT extends Block {
	public BlockETNT(int i) {
		super(i, Material.ground);
	}

	public int getBlockTextureFromSideAndMetadata(int i, int j) {
		return i == 1 ? 354 : (i == 0 ? 353 : 352);
	}
	...
	public void onBlockDestroyedByExplosion(World world, int i, int j, int k) {
		EntityETNTPrimed entityetntprimed = new EntityETNTPrimed(world, (double)((float)i + 0.5F), (double)((float)j + 0.5F), (double)((float)k + 0.5F));
	...
	public void onBlockDestroyedByPlayer(World world, int i, int j, int k, int l) {
		if(!world.isRemote) {
			EntityETNTPrimed entitytntprimed = new EntityETNTPrimed(world, (double)((float)i + 0.5F), (double)((float)j + 0.5F), (double)((float)k + 0.5F));
