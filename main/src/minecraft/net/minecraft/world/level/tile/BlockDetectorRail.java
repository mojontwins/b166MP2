...
public class BlockDetectorRail extends BlockRail {
	...
	private void setStateIfMinecartInteractsWithRail(World world1, int i2, int i3, int i4, int i5) {
		...
		boolean z7 = false;
		float f8 = 0.125F;
		List<Entity> list9 = world1.getEntitiesWithinAABB(EntityMinecart.class, AxisAlignedBB.getBoundingBoxFromPool((double)((float)i2 + f8), (double)i3, (double)((float)i4 + f8), (double)((float)(i2 + 1) - f8), (double)((float)(i3 + 1) - f8), (double)((float)(i4 + 1) - f8)));
		if(list9.size() > 0) {
			z7 = true;
		}
