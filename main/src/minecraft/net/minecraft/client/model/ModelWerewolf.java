...
public class ModelWerewolf extends ModelBase {
	...
	public ModelWerewolf() {
		...
		this.Torso2 = new ModelRenderer(this, 20, 7);
		...
		this.RightTigh = new ModelRenderer(this, 32, 20);
		...
		this.LeftTigh = new ModelRenderer(this, 32, 20);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		this.RightTigh.render(f5);
		this.LeftTigh.render(f5);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
		this.Head.rotateAngleY = f3 / 57.29578F / 2.0F;
		...
		this.RightTigh.rotateAngleX = -0.7853981F + MathHelper.cos(f * 0.6662F) * 1.4F * f1 / 3.0F;
		this.LeftTigh.rotateAngleX = -0.7853981F + MathHelper.cos(f * 0.6662F + 3.141593F) * 1.4F * f1 / 3.0F;
		this.RightLeg.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.4F * f1 / 2.0F;
		this.RightLeg.rotationPointZ = 3.0F + MathHelper.cos(f * 0.6662F) * 1.4F * f1 / 10.0F;
		this.RightLeg.rotationPointY = 7.5F + MathHelper.cos(f * 0.6662F) * 1.4F * f1;
		this.LeftLeg.rotateAngleX = MathHelper.cos(f * 0.6662F + 3.141593F) * 1.4F * f1 / 2.0F;
		this.LeftLeg.rotationPointZ = 3.0F + MathHelper.cos(f * 0.6662F + 3.141593F) * 1.4F * f1 / 10.0F;
		this.LeftLeg.rotationPointY = 7.5F + MathHelper.cos(f * 0.6662F + 3.141593F) * 1.4F * f1;
