...
public class ModelSpider extends ModelBase {
	...
	public ModelSpider() {
		...
		this.spiderHead.setRotationPoint(0.0F, (float)b2, -3.0F);
	...
	public void render(Entity entity1, float f2, float f3, float f4, float f5, float f6, float f7) {
		...
		this.spiderHead.render(f7);
		this.spiderNeck.render(f7);
		this.spiderBody.render(f7);
		this.spiderLeg1.render(f7);
		this.spiderLeg2.render(f7);
		this.spiderLeg3.render(f7);
		this.spiderLeg4.render(f7);
		this.spiderLeg5.render(f7);
		this.spiderLeg6.render(f7);
		this.spiderLeg7.render(f7);
		this.spiderLeg8.render(f7);
	}
