...
public class StatFileWriter {
	...
	public StatFileWriter(Session session1, File file2) {
		...
		this.field_27188_d = new StatsSyncher(session1, this, file3);
	}

	public void func_25100_a(StatBase statBase1, int i2) {
		this.func_27186_a(this.field_25101_b, statBase1, i2);
		this.func_27186_a(this.field_25102_a, statBase1, i2);
		this.field_27189_c = true;
	}

	private void func_27186_a(Map map1, StatBase statBase2, int i3) {
	...
	public void func_27179_a(Map map1) {
		if(map1 != null) {
			...
			while(iterator2.hasNext()) {
				...
				this.func_27186_a(this.field_25101_b, statBase3, ((Integer)map1.get(statBase3)).intValue());
				this.func_27186_a(this.field_25102_a, statBase3, ((Integer)map1.get(statBase3)).intValue());
			}
	...
	public int func_27184_a(StatBase statBase1) {
