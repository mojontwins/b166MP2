...
public class BlockRedstoneRepeater extends Block {
	...
	public boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		return !world1.func_28100_h(i2, i3 - 1, i4) ? false : super.canPlaceBlockAt(world1, i2, i3, i4);
	}

	public boolean canBlockStay(World world1, int i2, int i3, int i4) {
		return !world1.func_28100_h(i2, i3 - 1, i4) ? false : super.canBlockStay(world1, i2, i3, i4);
	}
