...
public class ItemMap extends ItemMapBase {
	...
	public void func_28011_a(World world1, Entity entity2, MapData mapData3) {
		if(world1.worldProvider.worldType == mapData3.field_28178_d) {
			...
			int i11 = 128 / i6;
			if(world1.worldProvider.field_6478_e) {
				i11 /= 2;
			}
					...
					for(int i17 = i10 - i11 - 1; i17 < i10 + i11; ++i17) {
						if(i12 >= 0 && i17 >= -1 && i12 < s4 && i17 < s5) {
									...
									for(i34 = 0; i34 < i6; ++i34) {
										...
										if(i35 > 1) {
											...
											while(true) {
												...
												if(i36 == 0) {
													z37 = false;
												} else if(i35 > 0 && i36 > 0 && Block.blocksList[i36].blockMaterial.materialMapColor == MapColor.field_28212_b) {
													z37 = false;
												}
							...
							if(i34 > 0) {
								...
								if(mapColor44 == MapColor.field_28200_n) {
