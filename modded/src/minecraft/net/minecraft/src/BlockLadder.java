...
public class BlockLadder extends Block {
	...
	public void onBlockPlaced(World world1, int i2, int i3, int i4, int i5) {
		...
		if((i6 == 0 || i5 == 2) && world1.func_28100_h(i2, i3, i4 + 1)) {
			i6 = 2;
		}

		if((i6 == 0 || i5 == 3) && world1.func_28100_h(i2, i3, i4 - 1)) {
			i6 = 3;
		}

		if((i6 == 0 || i5 == 4) && world1.func_28100_h(i2 + 1, i3, i4)) {
			i6 = 4;
		}

		if((i6 == 0 || i5 == 5) && world1.func_28100_h(i2 - 1, i3, i4)) {
			i6 = 5;
		}
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		int i6 = world1.getBlockMetadata(i2, i3, i4);
		boolean z7 = false;
		if(i6 == 2 && world1.func_28100_h(i2, i3, i4 + 1)) {
			z7 = true;
		}

		if(i6 == 3 && world1.func_28100_h(i2, i3, i4 - 1)) {
			z7 = true;
		}

		if(i6 == 4 && world1.func_28100_h(i2 + 1, i3, i4)) {
			z7 = true;
		}

		if(i6 == 5 && world1.func_28100_h(i2 - 1, i3, i4)) {
			z7 = true;
		}
