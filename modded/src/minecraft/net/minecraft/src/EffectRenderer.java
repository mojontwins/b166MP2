...
public class EffectRenderer {
			...
			for(int i8 = 0; i8 < b7; ++i8) {
				for(int i9 = 0; i9 < b7; ++i9) {
					for(int i10 = 0; i10 < b7; ++i10) {
						...
						this.addEffect((new EntityDiggingFX(this.worldObj, d11, d13, d15, d11 - (double)i1 - 0.5D, d13 - (double)i2 - 0.5D, d15 - (double)i3 - 0.5D, block6)).func_4041_a(i1, i2, i3));
					}
				}
			}
	...
	public void addBlockHitEffects(int i1, int i2, int i3, int i4) {
		...
		if(i5 != 0) {
			...
			this.addEffect((new EntityDiggingFX(this.worldObj, d8, d10, d12, 0.0D, 0.0D, 0.0D, block6)).func_4041_a(i1, i2, i3).func_407_b(0.2F).func_405_d(0.6F));
		}
	}
