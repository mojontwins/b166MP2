...
public class BlockButton extends Block {
	...
	public boolean canPlaceBlockOnSide(World world1, int i2, int i3, int i4, int i5) {
		return i5 == 2 && world1.func_28100_h(i2, i3, i4 + 1) ? true : (i5 == 3 && world1.func_28100_h(i2, i3, i4 - 1) ? true : (i5 == 4 && world1.func_28100_h(i2 + 1, i3, i4) ? true : i5 == 5 && world1.func_28100_h(i2 - 1, i3, i4)));
	}

	public boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		return world1.func_28100_h(i2 - 1, i3, i4) ? true : (world1.func_28100_h(i2 + 1, i3, i4) ? true : (world1.func_28100_h(i2, i3, i4 - 1) ? true : world1.func_28100_h(i2, i3, i4 + 1)));
	}
	...
	public void onBlockPlaced(World world1, int i2, int i3, int i4, int i5) {
		...
		if(i5 == 2 && world1.func_28100_h(i2, i3, i4 + 1)) {
			i6 = 4;
		} else if(i5 == 3 && world1.func_28100_h(i2, i3, i4 - 1)) {
			i6 = 3;
		} else if(i5 == 4 && world1.func_28100_h(i2 + 1, i3, i4)) {
			i6 = 2;
		} else if(i5 == 5 && world1.func_28100_h(i2 - 1, i3, i4)) {
			i6 = 1;
		} else {
	...
	private int getOrientation(World world1, int i2, int i3, int i4) {
		return world1.func_28100_h(i2 - 1, i3, i4) ? 1 : (world1.func_28100_h(i2 + 1, i3, i4) ? 2 : (world1.func_28100_h(i2, i3, i4 - 1) ? 3 : (world1.func_28100_h(i2, i3, i4 + 1) ? 4 : 1)));
	}
