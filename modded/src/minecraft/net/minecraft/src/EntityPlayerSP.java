...
public class EntityPlayerSP extends EntityPlayer {
		...
		if(statBase1 != null) {
			if(statBase1.func_25067_a()) {
				...
				if(achievement3.parentAchievement == null || this.mc.statFileWriter.hasAchievementUnlocked(achievement3.parentAchievement)) {
					...
					this.mc.statFileWriter.func_25100_a(statBase1, i2);
				}
			} else {
				this.mc.statFileWriter.func_25100_a(statBase1, i2);
			}
	...
	private boolean func_28027_d(int i1, int i2, int i3) {
		return this.worldObj.func_28100_h(i1, i2, i3);
	}

	protected boolean func_28014_c(double d1, double d3, double d5) {
		...
		if(this.func_28027_d(i7, i8, i9) || this.func_28027_d(i7, i8 + 1, i9)) {
			boolean z14 = !this.func_28027_d(i7 - 1, i8, i9) && !this.func_28027_d(i7 - 1, i8 + 1, i9);
			boolean z15 = !this.func_28027_d(i7 + 1, i8, i9) && !this.func_28027_d(i7 + 1, i8 + 1, i9);
			boolean z16 = !this.func_28027_d(i7, i8, i9 - 1) && !this.func_28027_d(i7, i8 + 1, i9 - 1);
			boolean z17 = !this.func_28027_d(i7, i8, i9 + 1) && !this.func_28027_d(i7, i8 + 1, i9 + 1);
			byte b18 = -1;
			double d19 = 9999.0D;
			if(z14 && d10 < d19) {
				d19 = d10;
