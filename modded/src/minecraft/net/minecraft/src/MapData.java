...
public class MapData extends MapDataBase {
	...
	public void func_28169_a(EntityPlayer entityPlayer1, ItemStack itemStack2) {
		...
		for(int i14 = 0; i14 < this.field_28174_h.size(); ++i14) {
			...
			if(!mapInfo4.field_28120_a.isDead && mapInfo4.field_28120_a.inventory.func_28018_c(itemStack2)) {
				float f5 = (float)(mapInfo4.field_28120_a.posX - (double)this.field_28180_b) / (float)(1 << this.field_28177_e);
				float f6 = (float)(mapInfo4.field_28120_a.posZ - (double)this.field_28179_c) / (float)(1 << this.field_28177_e);
				byte b7 = 64;
				byte b8 = 64;
				if(f5 >= (float)(-b7) && f6 >= (float)(-b8) && f5 <= (float)b7 && f6 <= (float)b8) {
					...
					if(mapInfo4.field_28120_a.dimension == this.field_28178_d) {
						this.field_28173_i.add(new MapCoord(this, b9, b10, b11, b12));
					}
				}
			} else {
				this.field_28172_j.remove(mapInfo4.field_28120_a);
