...
public class BlockRail extends Block {
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		if(!world1.multiplayerWorld) {
			...
			if(i7 == 2 && !world1.func_28100_h(i2 + 1, i3, i4)) {
				z8 = true;
			}

			if(i7 == 3 && !world1.func_28100_h(i2 - 1, i3, i4)) {
				z8 = true;
			}

			if(i7 == 4 && !world1.func_28100_h(i2, i3, i4 - 1)) {
				z8 = true;
			}

			if(i7 == 5 && !world1.func_28100_h(i2, i3, i4 + 1)) {
				z8 = true;
			}
