...
public abstract class Entity {
	...
	public boolean isEntityInsideOpaqueBlock() {
		for(int i1 = 0; i1 < 8; ++i1) {
			...
			if(this.worldObj.func_28100_h(i5, i6, i7)) {
				return true;
			}
		}
	...
	protected boolean func_28014_c(double d1, double d3, double d5) {
		...
		if(this.worldObj.func_28100_h(i7, i8, i9)) {
			boolean z16 = !this.worldObj.func_28100_h(i7 - 1, i8, i9);
			boolean z17 = !this.worldObj.func_28100_h(i7 + 1, i8, i9);
			boolean z18 = !this.worldObj.func_28100_h(i7, i8 - 1, i9);
			boolean z19 = !this.worldObj.func_28100_h(i7, i8 + 1, i9);
			boolean z20 = !this.worldObj.func_28100_h(i7, i8, i9 - 1);
			boolean z21 = !this.worldObj.func_28100_h(i7, i8, i9 + 1);
			byte b22 = -1;
			double d23 = 9999.0D;
			if(z16 && d10 < d23) {
				d23 = d10;
