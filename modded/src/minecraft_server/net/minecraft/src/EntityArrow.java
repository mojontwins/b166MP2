...
public class EntityArrow extends Entity {
	...
	public EntityArrow(World world1, EntityLiving entityLiving2) {
		...
		this.field_28012_a = entityLiving2 instanceof EntityPlayer;
		this.setSize(0.5F, 0.5F);
	...
	public void onUpdate() {
		...
		if(i15 > 0) {
			...
			if(axisAlignedBB2 != null && axisAlignedBB2.isVecInXYZ(Vec3D.createVector(this.posX, this.posY, this.posZ))) {
				this.inGround = true;
			}
		}
		...
		if(this.inGround) {
			...
			if(i15 == this.inTile && i18 == this.field_28011_h) {
				++this.ticksInGround;
			...
			MovingObjectPosition movingObjectPosition3 = this.worldObj.func_28099_a(vec3D16, vec3D17, false, true);
			...
			for(int i8 = 0; i8 < list5.size(); ++i8) {
				...
				if(entity9.canBeCollidedWith() && (entity9 != this.owner || this.ticksInAir >= 5)) {
					...
					MovingObjectPosition movingObjectPosition12 = axisAlignedBB11.func_706_a(vec3D16, vec3D17);
	...
	public void writeEntityToNBT(NBTTagCompound nBTTagCompound1) {
		...
		nBTTagCompound1.setByte("inData", (byte)this.field_28011_h);
		nBTTagCompound1.setByte("shake", (byte)this.arrowShake);
		nBTTagCompound1.setByte("inGround", (byte)(this.inGround ? 1 : 0));
		nBTTagCompound1.setBoolean("player", this.field_28012_a);
	}
	...
	public void readEntityFromNBT(NBTTagCompound nBTTagCompound1) {
		...
		this.field_28011_h = nBTTagCompound1.getByte("inData") & 255;
		this.arrowShake = nBTTagCompound1.getByte("shake") & 255;
		this.inGround = nBTTagCompound1.getByte("inGround") == 1;
		this.field_28012_a = nBTTagCompound1.getBoolean("player");
	}

	public void onCollideWithPlayer(EntityPlayer entityPlayer1) {
		if(!this.worldObj.singleplayerWorld) {
			if(this.inGround && this.field_28012_a && this.arrowShake <= 0 && entityPlayer1.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1))) {
