...
public final class ItemStack {
	...
	public boolean useItem(EntityPlayer entityPlayer1, World world2, int i3, int i4, int i5, int i6) {
		...
		if(z7) {
			entityPlayer1.addStat(StatList.field_25107_A[this.itemID], 1);
		}
	...
	public void func_25125_a(int i1, Entity entity2) {
		if(this.isItemStackDamageable()) {
			this.itemDamage += i1;
			if(this.itemDamage > this.getMaxDamage()) {
				if(entity2 instanceof EntityPlayer) {
					((EntityPlayer)entity2).addStat(StatList.field_25105_B[this.itemID], 1);
				}
	...
	public void hitEntity(EntityLiving entityLiving1, EntityPlayer entityPlayer2) {
		...
		if(z3) {
			entityPlayer2.addStat(StatList.field_25107_A[this.itemID], 1);
		}

	}

	public void func_25124_a(int i1, int i2, int i3, int i4, EntityPlayer entityPlayer5) {
		boolean z6 = Item.itemsList[this.itemID].func_25007_a(this, i1, i2, i3, i4, entityPlayer5);
		if(z6) {
			entityPlayer5.addStat(StatList.field_25107_A[this.itemID], 1);
		}
	...
	public void func_577_a(EntityPlayer entityPlayer1) {
	}
	...
	public static ItemStack func_20117_a(ItemStack itemStack0) {
	...
	public void func_28143_a(World world1, Entity entity2, int i3, boolean z4) {
		if(this.animationsToGo > 0) {
			--this.animationsToGo;
		}

		Item.itemsList[this.itemID].func_28018_a(this, world1, entity2, i3, z4);
	}

	public void func_28142_b(World world1, EntityPlayer entityPlayer2) {
		entityPlayer2.addStat(StatList.field_25093_z[this.itemID], this.stackSize);
		Item.itemsList[this.itemID].func_28020_c(this, world1, entityPlayer2);
	}

	public boolean func_28144_c(ItemStack itemStack1) {
