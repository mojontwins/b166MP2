...
public class BlockButton extends Block {
	...
	public boolean func_28026_e(World world1, int i2, int i3, int i4, int i5) {
		return i5 == 2 && world1.isBlockOpaqueCube(i2, i3, i4 + 1) ? true : (i5 == 3 && world1.isBlockOpaqueCube(i2, i3, i4 - 1) ? true : (i5 == 4 && world1.isBlockOpaqueCube(i2 + 1, i3, i4) ? true : i5 == 5 && world1.isBlockOpaqueCube(i2 - 1, i3, i4)));
	}
	...
	public void onBlockPlaced(World world1, int i2, int i3, int i4, int i5) {
		...
		if(i5 == 2 && world1.isBlockOpaqueCube(i2, i3, i4 + 1)) {
			i6 = 4;
		} else if(i5 == 3 && world1.isBlockOpaqueCube(i2, i3, i4 - 1)) {
			i6 = 3;
		} else if(i5 == 4 && world1.isBlockOpaqueCube(i2 + 1, i3, i4)) {
			i6 = 2;
		} else if(i5 == 5 && world1.isBlockOpaqueCube(i2 - 1, i3, i4)) {
			i6 = 1;
		} else {
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		if(this.func_322_g(world1, i2, i3, i4)) {
	...
	private boolean func_322_g(World world1, int i2, int i3, int i4) {
