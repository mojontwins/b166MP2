...
public class EntitySnowball extends Entity {
	...
	public void func_6141_a(double d1, double d3, double d5, float f7, float f8) {
	...
	public void onCollideWithPlayer(EntityPlayer entityPlayer1) {
		if(this.inGroundSnowball && this.owner == entityPlayer1 && this.shakeSnowball <= 0 && entityPlayer1.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1))) {
