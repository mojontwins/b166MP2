...
public class ItemDye extends Item {
	...
	public boolean onItemUse(ItemStack itemStack1, EntityPlayer entityPlayer2, World world3, int i4, int i5, int i6, int i7) {
		if(itemStack1.getItemDamage() == 15) {
			...
			if(i8 == Block.sapling.blockID) {
				if(!world3.singleplayerWorld) {
					((BlockSapling)Block.sapling).func_21027_b(world3, i4, i5, i6, world3.rand);
				...
				if(!world3.singleplayerWorld) {
					...
					for(int i9 = 0; i9 < 128; ++i9) {
						...
						for(int i13 = 0; i13 < i9 / 16; ++i13) {
							...
							if(world3.getBlockId(i10, i11 - 1, i12) != Block.grass.blockID || world3.isBlockOpaqueCube(i10, i11, i12)) {
								continue label53;
							}
						}
						...
						if(world3.getBlockId(i10, i11, i12) == 0) {
							if(itemRand.nextInt(10) != 0) {
								world3.setBlockAndMetadataWithNotify(i10, i11, i12, Block.field_9031_X.blockID, 1);
	...
	public void saddleEntity(ItemStack itemStack1, EntityLiving entityLiving2) {
		if(entityLiving2 instanceof EntitySheep) {
			...
			int i4 = BlockCloth.func_21033_c(itemStack1.getItemDamage());
			if(!entitySheep3.func_21069_f_() && entitySheep3.getFleeceColor() != i4) {
