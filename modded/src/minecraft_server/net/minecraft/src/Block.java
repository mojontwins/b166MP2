...
public class Block {
	...
	public static final Block torchWood = (new BlockTorch(50, 80)).setHardness(0.0F).setLightValue(0.9375F).setStepSound(soundWoodFootstep).setBlockName("torch").func_28027_k();
	...
	public static final Block stoneOvenActive = (new BlockFurnace(62, true)).setHardness(3.5F).setStepSound(soundStoneFootstep).setLightValue(0.875F).setBlockName("furnace").func_28027_k();
	...
	public static final Block oreRedstoneGlowing = (new BlockRedstoneOre(74, 51, true)).setLightValue(0.625F).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setBlockName("oreRedstone").func_28027_k();
	...
	public static final Block redstoneRepeaterActive = (new BlockRedstoneRepeater(94, true)).setHardness(0.0F).setLightValue(0.625F).setStepSound(soundWoodFootstep).setBlockName("diode").disableStats().func_28027_k();
	...
	protected Block(int i1, Material material2) {
		...
		if(blocksList[i1] != null) {
			...
			field_537_s[i1] = !material2.getCanBlockGrass();
		...
		if(!world1.singleplayerWorld) {
			...
			for(int i8 = 0; i8 < i7; ++i8) {
				if(world1.rand.nextFloat() <= f6) {
					...
					if(i9 > 0) {
						float f10 = 0.7F;
						double d11 = (double)(world1.rand.nextFloat() * f10) + (double)(1.0F - f10) * 0.5D;
						double d13 = (double)(world1.rand.nextFloat() * f10) + (double)(1.0F - f10) * 0.5D;
						double d15 = (double)(world1.rand.nextFloat() * f10) + (double)(1.0F - f10) * 0.5D;
	...
	public boolean func_28026_e(World world1, int i2, int i3, int i4, int i5) {
		return this.canPlaceBlockAt(world1, i2, i3, i4);
	}

	public boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		int i5 = world1.getBlockId(i2, i3, i4);
		return i5 == 0 || blocksList[i5].blockMaterial.func_27090_g();
	}
