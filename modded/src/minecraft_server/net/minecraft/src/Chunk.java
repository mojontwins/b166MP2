...
public class Chunk {
	...
	private void func_333_c(int i1, int i2) {
		int i3 = this.getHeightValue(i1, i2);
		int i4 = this.xPosition * 16 + i1;
		int i5 = this.zPosition * 16 + i2;
		this.func_355_f(i4 - 1, i5, i3);
		this.func_355_f(i4 + 1, i5, i3);
		this.func_355_f(i4, i5 - 1, i3);
		this.func_355_f(i4, i5 + 1, i3);
	}

	private void func_355_f(int i1, int i2, int i3) {
		int i4 = this.worldObj.getHeightValue(i1, i2);
		if(i4 > i3) {
			this.worldObj.func_483_a(EnumSkyBlock.Sky, i1, i3, i2, i1, i4, i2);
			this.isModified = true;
		} else if(i4 < i3) {
			this.worldObj.func_483_a(EnumSkyBlock.Sky, i1, i4, i2, i1, i3, i2);
			this.isModified = true;
		}

	}

	private void func_339_g(int i1, int i2, int i3) {
		...
		if(i5 != i4) {
			...
			if(i5 < i4) {
				...
				this.worldObj.func_483_a(EnumSkyBlock.Sky, i7, i4, i8, i7, i5, i8);
			...
			if(i5 != i10) {
				this.worldObj.func_483_a(EnumSkyBlock.Sky, i7 - 1, i5, i8 - 1, i7 + 1, i10, i8 + 1);
			}
	...
	public boolean setBlockIDWithMetadata(int i1, int i2, int i3, int i4, int i5) {
		...
		if(i8 == i4 && this.data.getNibble(i1, i2, i3) == i5) {
			...
			if(i8 != 0 && !this.worldObj.singleplayerWorld) {
			...
			if(!this.worldObj.worldProvider.field_4306_c) {
				if(Block.lightOpacity[b6 & 255] != 0) {
					if(i2 >= i7) {
						this.func_339_g(i1, i2 + 1, i3);
					}
				} else if(i2 == i7 - 1) {
					this.func_339_g(i1, i2, i3);
				}

				this.worldObj.func_483_a(EnumSkyBlock.Sky, i9, i2, i10, i9, i2, i10);
			}

			this.worldObj.func_483_a(EnumSkyBlock.Block, i9, i2, i10, i9, i2, i10);
			this.func_333_c(i1, i3);
			this.data.setNibble(i1, i2, i3, i5);
			if(i4 != 0) {
	...
	public boolean setBlockID(int i1, int i2, int i3, int i4) {
		...
		if(i7 == i4) {
			...
			this.worldObj.func_483_a(EnumSkyBlock.Sky, i8, i2, i9, i8, i2, i9);
			this.worldObj.func_483_a(EnumSkyBlock.Block, i8, i2, i9, i8, i2, i9);
			this.func_333_c(i1, i3);
			if(i4 != 0 && !this.worldObj.singleplayerWorld) {
	...
	public void func_349_a(TileEntity tileEntity1) {
	...
	public void onChunkLoad() {
		...
		for(int i1 = 0; i1 < this.entities.length; ++i1) {
			this.worldObj.func_464_a(this.entities[i1]);
		}
	...
	public void onChunkUnload() {
		...
		for(int i1 = 0; i1 < this.entities.length; ++i1) {
			this.worldObj.func_461_b(this.entities[i1]);
		}
	...
	public Random func_334_a(long j1) {
