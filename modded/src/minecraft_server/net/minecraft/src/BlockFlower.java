...
public class BlockFlower extends Block {
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		...
		this.func_276_g(world1, i2, i3, i4);
	}
	...
	protected final void func_276_g(World world1, int i2, int i3, int i4) {
	...
	public boolean canBlockStay(World world1, int i2, int i3, int i4) {
		return (world1.func_28098_j(i2, i3, i4) >= 8 || world1.canBlockSeeTheSky(i2, i3, i4)) && this.canThisPlantGrowOnThisBlockID(world1.getBlockId(i2, i3 - 1, i4));
	}
