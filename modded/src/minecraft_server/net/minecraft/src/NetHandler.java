...
public abstract class NetHandler {
	...
	public void func_6002_a(Packet28EntityVelocity packet28EntityVelocity1) {
		this.registerPacket(packet28EntityVelocity1);
	}

	public void func_21002_a(Packet40EntityMetadata packet40EntityMetadata1) {
		this.registerPacket(packet40EntityMetadata1);
	}

	public void func_6003_a(Packet39AttachEntity packet39AttachEntity1) {
	...
	public void func_9001_a(Packet38EntityStatus packet38EntityStatus1) {
	...
	public void func_12001_a(Packet60Explosion packet60Explosion1) {
		this.registerPacket(packet60Explosion1);
	}

	public void func_20004_a(Packet100OpenWindow packet100OpenWindow1) {
	...
	public void func_20003_a(Packet103SetSlot packet103SetSlot1) {
		this.registerPacket(packet103SetSlot1);
	}

	public void func_20001_a(Packet104WindowItems packet104WindowItems1) {
		this.registerPacket(packet104WindowItems1);
	}

	public void func_20005_a(Packet130UpdateSign packet130UpdateSign1) {
		this.registerPacket(packet130UpdateSign1);
	}

	public void func_20002_a(Packet105UpdateProgressbar packet105UpdateProgressbar1) {
	...
	public void func_21003_a(Packet25EntityPainting packet25EntityPainting1) {
		this.registerPacket(packet25EntityPainting1);
	}

	public void func_21004_a(Packet54PlayNoteBlock packet54PlayNoteBlock1) {
		this.registerPacket(packet54PlayNoteBlock1);
	}

	public void func_27001_a(Packet200Statistic packet200Statistic1) {
		this.registerPacket(packet200Statistic1);
	}

	public void func_22002_a(Packet17Sleep packet17Sleep1) {
	...
	public void func_25001_a(Packet70Bed packet70Bed1) {
		this.registerPacket(packet70Bed1);
	}

	public void func_27002_a(Packet71Weather packet71Weather1) {
		this.registerPacket(packet71Weather1);
	}

	public void func_28001_a(Packet131MapData packet131MapData1) {
		this.registerPacket(packet131MapData1);
	}

	public void func_28002_a(Packet61DoorChange packet61DoorChange1) {
