...
public class InventoryPlayer implements IInventory {
	...
	private int func_21082_c(ItemStack itemStack1) {
		for(int i2 = 0; i2 < this.mainInventory.length; ++i2) {
			if(this.mainInventory[i2] != null && this.mainInventory[i2].itemID == itemStack1.itemID && this.mainInventory[i2].func_21132_c() && this.mainInventory[i2].stackSize < this.mainInventory[i2].getMaxStackSize() && this.mainInventory[i2].stackSize < this.getInventoryStackLimit() && (!this.mainInventory[i2].getHasSubtypes() || this.mainInventory[i2].getItemDamage() == itemStack1.getItemDamage())) {
				return i2;
			}
		}
	...
	private int func_21083_d(ItemStack itemStack1) {
		int i2 = itemStack1.itemID;
		int i3 = itemStack1.stackSize;
		int i4 = this.func_21082_c(itemStack1);
		if(i4 < 0) {
	...
	public void decrementAnimations() {
		for(int i1 = 0; i1 < this.mainInventory.length; ++i1) {
			if(this.mainInventory[i1] != null) {
				this.mainInventory[i1].func_28143_a(this.player.worldObj, this.player, i1, this.currentItem == i1);
			}
		}
	...
	public boolean addItemStackToInventory(ItemStack itemStack1) {
		...
		if(itemStack1.isItemDamaged()) {
			...
			if(i2 >= 0) {
				this.mainInventory[i2] = ItemStack.func_20117_a(itemStack1);
			...
			do {
				...
				itemStack1.stackSize = this.func_21083_d(itemStack1);
	...
	public void damageArmor(int i1) {
		for(int i2 = 0; i2 < this.armorInventory.length; ++i2) {
			if(this.armorInventory[i2] != null && this.armorInventory[i2].getItem() instanceof ItemArmor) {
				this.armorInventory[i2].func_25125_a(i1, this.player);
				if(this.armorInventory[i2].stackSize == 0) {
					this.armorInventory[i2].func_577_a(this.player);
	...
	public boolean func_28010_c(ItemStack itemStack1) {
		int i2;
		for(i2 = 0; i2 < this.armorInventory.length; ++i2) {
			if(this.armorInventory[i2] != null && this.armorInventory[i2].func_28144_c(itemStack1)) {
				return true;
			}
		}

		for(i2 = 0; i2 < this.mainInventory.length; ++i2) {
			if(this.mainInventory[i2] != null && this.mainInventory[i2].func_28144_c(itemStack1)) {
				return true;
			}
		}
