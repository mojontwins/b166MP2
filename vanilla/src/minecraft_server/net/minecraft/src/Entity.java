...
public abstract class Entity {
	...
	public void moveEntity(double d1, double d3, double d5) {
		if(this.noClip) {
			...
			int i38;
			int i39;
			if(this.func_25017_l() && !z18 && this.ridingEntity == null) {
				...
				if(this.distanceWalkedModified > (float)this.nextStepDistance && i28 > 0) {
					...
					if(this.worldObj.getBlockId(i38, i26 + 1, i39) == Block.snow.blockID) {
						...
						this.worldObj.playSoundAtEntity(this, stepSound29.func_737_c(), stepSound29.getVolume() * 0.15F, stepSound29.getPitch());
	...
	public boolean isInsideOfMaterial(Material material1) {
		...
		if(i7 != 0 && Block.blocksList[i7].blockMaterial == material1) {
			float f8 = BlockFluid.setFluidHeight(this.worldObj.getBlockMetadata(i4, i5, i6)) - 0.11111111F;
	...
	public boolean isEntityInsideOpaqueBlock() {
		for(int i1 = 0; i1 < 8; ++i1) {
			...
			if(this.worldObj.isBlockOpaqueCube(i5, i6, i7)) {
				return true;
			}
		}
	...
	public void func_21043_b(boolean z1) {
		this.func_21041_a(1, z1);
	}

	protected boolean func_21042_c(int i1) {
		return (this.dataWatcher.getWatchableObjectByte(0) & 1 << i1) != 0;
	}

	protected void func_21041_a(int i1, boolean z2) {
	...
	protected boolean func_28005_g(double d1, double d3, double d5) {
		...
		if(this.worldObj.isBlockOpaqueCube(i7, i8, i9)) {
			boolean z16 = !this.worldObj.isBlockOpaqueCube(i7 - 1, i8, i9);
			boolean z17 = !this.worldObj.isBlockOpaqueCube(i7 + 1, i8, i9);
			boolean z18 = !this.worldObj.isBlockOpaqueCube(i7, i8 - 1, i9);
			boolean z19 = !this.worldObj.isBlockOpaqueCube(i7, i8 + 1, i9);
			boolean z20 = !this.worldObj.isBlockOpaqueCube(i7, i8, i9 - 1);
			boolean z21 = !this.worldObj.isBlockOpaqueCube(i7, i8, i9 + 1);
			byte b22 = -1;
			double d23 = 9999.0D;
			if(z16 && d10 < d23) {
				d23 = d10;
