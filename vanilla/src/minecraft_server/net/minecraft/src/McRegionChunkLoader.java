...
public class McRegionChunkLoader implements IChunkLoader {
	...
	public McRegionChunkLoader(File file1) {
		this.field_22110_a = file1;
	}

	public Chunk loadChunk(World world1, int i2, int i3) throws IOException {
		DataInputStream dataInputStream4 = RegionFileCache.func_22124_c(this.field_22110_a, i2, i3);
	...
	public void saveChunk(World world1, Chunk chunk2) throws IOException {
		...
		try {
			DataOutputStream dataOutputStream3 = RegionFileCache.func_22120_d(this.field_22110_a, chunk2.xPosition, chunk2.zPosition);
			...
			worldInfo6.setSizeOnDisk(worldInfo6.getSizeOnDisk() + (long)RegionFileCache.func_22121_b(this.field_22110_a, chunk2.xPosition, chunk2.zPosition));
