...
public class EntitySheep extends EntityAnimal {
	...
	public boolean attackEntityFrom(Entity entity1, int i2) {
		if(!this.worldObj.singleplayerWorld && !this.func_21069_f_() && entity1 instanceof EntityLiving) {
	...
	public void writeEntityToNBT(NBTTagCompound nBTTagCompound1) {
		...
		nBTTagCompound1.setBoolean("Sheared", this.func_21069_f_());
	...
	public static int func_21066_a(Random random0) {
