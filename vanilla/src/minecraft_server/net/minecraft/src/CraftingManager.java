...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		this.addRecipe(new ItemStack(Block.field_28030_bl, 2), new Object[]{"###", "###", '#', Block.planks});
		...
		this.addRecipe(new ItemStack(Item.field_28021_bb, 1), new Object[]{"###", "#X#", "###", '#', Item.paper, 'X', Item.compass});
	...
	public ItemStack findMatchingRecipe(InventoryCrafting inventoryCrafting1) {
		for(int i2 = 0; i2 < this.recipes.size(); ++i2) {
			...
			if(iRecipe3.func_21134_a(inventoryCrafting1)) {
