...
public class BlockRedstoneOre extends Block {
	...
	public void onBlockClicked(World world1, int i2, int i3, int i4, EntityPlayer entityPlayer5) {
		this.func_321_g(world1, i2, i3, i4);
	...
	private void func_321_g(World world1, int i2, int i3, int i4) {
	...
	private void func_320_h(World world1, int i2, int i3, int i4) {
		...
		for(int i8 = 0; i8 < 6; ++i8) {
			...
			if(i8 == 0 && !world1.func_28095_p(i2, i3 + 1, i4)) {
				d11 = (double)(i3 + 1) + d6;
			}

			if(i8 == 1 && !world1.func_28095_p(i2, i3 - 1, i4)) {
				d11 = (double)(i3 + 0) - d6;
			}

			if(i8 == 2 && !world1.func_28095_p(i2, i3, i4 + 1)) {
				d13 = (double)(i4 + 1) + d6;
			}

			if(i8 == 3 && !world1.func_28095_p(i2, i3, i4 - 1)) {
				d13 = (double)(i4 + 0) - d6;
			}

			if(i8 == 4 && !world1.func_28095_p(i2 + 1, i3, i4)) {
				d9 = (double)(i2 + 1) + d6;
			}

			if(i8 == 5 && !world1.func_28095_p(i2 - 1, i3, i4)) {
				d9 = (double)(i2 + 0) - d6;
			}
