...
public class BlockChest extends BlockContainer {
	...
	public boolean blockActivated(World world1, int i2, int i3, int i4, EntityPlayer entityPlayer5) {
		...
		if(world1.isBlockOpaqueCube(i2, i3 + 1, i4)) {
			return true;
		} else if(world1.getBlockId(i2 - 1, i3, i4) == this.blockID && world1.isBlockOpaqueCube(i2 - 1, i3 + 1, i4)) {
			return true;
		} else if(world1.getBlockId(i2 + 1, i3, i4) == this.blockID && world1.isBlockOpaqueCube(i2 + 1, i3 + 1, i4)) {
			return true;
		} else if(world1.getBlockId(i2, i3, i4 - 1) == this.blockID && world1.isBlockOpaqueCube(i2, i3 + 1, i4 - 1)) {
			return true;
		} else if(world1.getBlockId(i2, i3, i4 + 1) == this.blockID && world1.isBlockOpaqueCube(i2, i3 + 1, i4 + 1)) {
			return true;
		} else {
