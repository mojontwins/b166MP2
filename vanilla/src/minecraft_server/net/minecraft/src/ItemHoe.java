...
public class ItemHoe extends Item {
	...
	public boolean onItemUse(ItemStack itemStack1, EntityPlayer entityPlayer2, World world3, int i4, int i5, int i6, int i7) {
		...
		if((i7 == 0 || i9 != 0 || i8 != Block.grass.blockID) && i8 != Block.dirt.blockID) {
			...
			world3.playSoundEffect((double)((float)i4 + 0.5F), (double)((float)i5 + 0.5F), (double)((float)i6 + 0.5F), block10.stepSound.func_737_c(), (block10.stepSound.getVolume() + 1.0F) / 2.0F, block10.stepSound.getPitch() * 0.8F);
			if(world3.singleplayerWorld) {
				return true;
			} else {
				world3.setBlockWithNotify(i4, i5, i6, block10.blockID);
				itemStack1.func_25125_a(1, entityPlayer2);
				return true;
			}
		}
	}
