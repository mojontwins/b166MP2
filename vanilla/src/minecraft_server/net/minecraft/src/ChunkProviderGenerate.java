...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void populate(IChunkProvider iChunkProvider1, int i2, int i3) {
		...
		for(i17 = 0; i17 < b28; ++i17) {
			...
			(new WorldGenTallGrass(Block.field_9031_X.blockID, b26)).generate(this.worldObj, this.rand, i19, i20, i21);
		}
		...
		for(i17 = 0; i17 < b28; ++i17) {
			...
			(new WorldGenDeadBush(Block.field_9030_Y.blockID)).generate(this.worldObj, this.rand, i25, i19, i20);
		}
		...
		for(i25 = i4 + 8; i25 < i4 + 8 + 16; ++i25) {
			for(i19 = i5 + 8; i19 < i5 + 8 + 16; ++i19) {
				i20 = i25 - (i4 + 8);
				i21 = i19 - (i5 + 8);
				int i22 = this.worldObj.func_28100_e(i25, i19);
