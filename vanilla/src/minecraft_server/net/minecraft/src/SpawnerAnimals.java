...
public final class SpawnerAnimals {
	...
	public static final int performSpawning(World world0, boolean z1, boolean z2) {
		if(!z1 && !z2) {
			...
			for(int i37 = 0; i37 < i6; ++i37) {
				...
				if((!enumCreatureType38.func_21103_d() || z2) && (enumCreatureType38.func_21103_d() || z1) && world0.countEntities(enumCreatureType38.getCreatureClass()) <= enumCreatureType38.getMaxNumberOfCreature() * eligibleChunksForSpawning.size() / 256) {
					...
					while(true) {
						...
						do {
							do {
								...
								do {
									do {
										...
										BiomeGenBase biomeGenBase11 = world0.getWorldChunkManager().func_4066_a(chunkCoordIntPair10);
							...
							} while(world0.isBlockOpaqueCube(i42, i18, i19));
						...
						for(int i21 = 0; i21 < 3; ++i21) {
							...
							for(int i26 = 0; i26 < 4; ++i26) {
								...
								if(func_21167_a(enumCreatureType38, world0, i22, i23, i24)) {
									float f27 = (float)i22 + 0.5F;
									float f28 = (float)i23;
									float f29 = (float)i24 + 0.5F;
									if(world0.getClosestPlayer((double)f27, (double)f28, (double)f29, 24.0D) == null) {
										float f30 = f27 - (float)chunkCoordinates35.posX;
										float f31 = f28 - (float)chunkCoordinates35.posY;
										float f32 = f29 - (float)chunkCoordinates35.posZ;
										...
										if(f33 >= 576.0F) {
											...
											if(entityLiving43.getCanSpawnHere()) {
												...
												func_21166_a(entityLiving43, world0, f27, f28, f29);
	...
	private static boolean func_21167_a(EnumCreatureType enumCreatureType0, World world1, int i2, int i3, int i4) {
	...
	private static void func_21166_a(EntityLiving entityLiving0, World world1, float f2, float f3, float f4) {
		if(entityLiving0 instanceof EntitySpider && world1.rand.nextInt(100) == 0) {
			...
			((EntitySheep)entityLiving0).setFleeceColor(EntitySheep.func_21066_a(world1.rand));
		}
	...
	public static boolean performSleepSpawning(World world0, List list1) {
		...
		while(true) {
			...
			for(int i8 = 0; i8 < 20 && !z7; ++i8) {
				...
				int i13;
				for(i13 = i11; i13 > 2 && !world0.isBlockOpaqueCube(i9, i13 - 1, i10); --i13) {
				}

				while(!func_21167_a(EnumCreatureType.monster, world0, i9, i13, i10) && i13 < i11 + 16 && i13 < 128) {
					++i13;
				}
				...
				if(i13 < i11 + 16 && i13 < 128) {
					...
					if(entityLiving17.getCanSpawnHere()) {
						...
						if(pathEntity18 != null && pathEntity18.pathLength > 1) {
							PathPoint pathPoint19 = pathEntity18.func_22211_c();
							if(Math.abs((double)pathPoint19.xCoord - entityPlayer5.posX) < 1.5D && Math.abs((double)pathPoint19.zCoord - entityPlayer5.posZ) < 1.5D && Math.abs((double)pathPoint19.yCoord - entityPlayer5.posY) < 1.5D) {
								ChunkCoordinates chunkCoordinates20 = BlockBed.func_22021_g(world0, MathHelper.floor_double(entityPlayer5.posX), MathHelper.floor_double(entityPlayer5.posY), MathHelper.floor_double(entityPlayer5.posZ), 1);
								...
								func_21166_a(entityLiving17, world0, (float)chunkCoordinates20.posX + 0.5F, (float)chunkCoordinates20.posY, (float)chunkCoordinates20.posZ + 0.5F);
