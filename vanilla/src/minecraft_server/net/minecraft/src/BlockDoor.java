...
public class BlockDoor extends Block {
	...
	public void setBlockBoundsBasedOnState(IBlockAccess iBlockAccess1, int i2, int i3, int i4) {
		this.func_273_b(this.func_271_d(iBlockAccess1.getBlockMetadata(i2, i3, i4)));
	}

	public void func_273_b(int i1) {
		float f2 = 0.1875F;
	...
	public void func_272_a(World world1, int i2, int i3, int i4, boolean z5) {
		int i6 = world1.getBlockMetadata(i2, i3, i4);
		if((i6 & 8) != 0) {
			if(world1.getBlockId(i2, i3 - 1, i4) == this.blockID) {
				this.func_272_a(world1, i2, i3 - 1, i4, z5);
			}
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		...
		if((i6 & 8) != 0) {
			...
			if(z7) {
				...
				this.func_272_a(world1, i2, i3, i4, z8);
			}
		}
	...
	public static boolean func_27036_e(int i0) {
		return (i0 & 4) != 0;
	}
}
