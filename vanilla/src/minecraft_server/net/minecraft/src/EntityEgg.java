...
public class EntityEgg extends Entity {
	...
	public EntityEgg(World world1, EntityLiving entityLiving2) {
		super(world1);
		this.field_20083_aj = entityLiving2;
		this.setSize(0.25F, 0.25F);
	...
	public void func_20078_a(double d1, double d3, double d5, float f7, float f8) {
	...
	public void onUpdate() {
		...
		if(!this.worldObj.singleplayerWorld) {
			...
			for(int i8 = 0; i8 < list5.size(); ++i8) {
				...
				if(entity9.canBeCollidedWith() && (entity9 != this.field_20083_aj || this.field_20079_al >= 5)) {
					float f10 = 0.3F;
		...
		if(movingObjectPosition3 != null) {
			if(movingObjectPosition3.entityHit != null && movingObjectPosition3.entityHit.attackEntityFrom(this.field_20083_aj, 0)) {
				;
			}
	...
	public void onCollideWithPlayer(EntityPlayer entityPlayer1) {
		if(this.inGround && this.field_20083_aj == entityPlayer1 && this.shake <= 0 && entityPlayer1.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1))) {
