...
public class NetworkManager {
	...
	static DataOutputStream func_28136_f(NetworkManager networkManager0) {
		return networkManager0.socketOutputStream;
	}

	static boolean func_28135_e(NetworkManager networkManager0) {
		return networkManager0.isTerminating;
	}

	static void func_30008_a(NetworkManager networkManager0, Exception exception1) {
