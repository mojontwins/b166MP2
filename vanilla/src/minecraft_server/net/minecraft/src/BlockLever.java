...
public class BlockLever extends Block {
	...
	public boolean func_28026_e(World world1, int i2, int i3, int i4, int i5) {
		return i5 == 1 && world1.isBlockOpaqueCube(i2, i3 - 1, i4) ? true : (i5 == 2 && world1.isBlockOpaqueCube(i2, i3, i4 + 1) ? true : (i5 == 3 && world1.isBlockOpaqueCube(i2, i3, i4 - 1) ? true : (i5 == 4 && world1.isBlockOpaqueCube(i2 + 1, i3, i4) ? true : i5 == 5 && world1.isBlockOpaqueCube(i2 - 1, i3, i4))));
	}
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		if(this.checkIfAttachedToBlock(world1, i2, i3, i4)) {
			...
			if(!world1.isBlockOpaqueCube(i2, i3 - 1, i4) && i6 == 6) {
				z7 = true;
			}
