...
public class BlockTrapDoor extends Block {
	...
	public void setBlockBoundsBasedOnState(IBlockAccess iBlockAccess1, int i2, int i3, int i4) {
		this.func_28039_c(iBlockAccess1.getBlockMetadata(i2, i3, i4));
	}

	public void func_28039_c(int i1) {
		float f2 = 0.1875F;
	...
	public boolean blockActivated(World world1, int i2, int i3, int i4, EntityPlayer entityPlayer5) {
		if(this.blockMaterial == Material.iron) {
			...
			world1.func_28101_a(entityPlayer5, 1003, i2, i3, i4, 0);
			return true;
		}
	}

	public void func_28040_a(World world1, int i2, int i3, int i4, boolean z5) {
		int i6 = world1.getBlockMetadata(i2, i3, i4);
		boolean z7 = (i6 & 4) > 0;
		if(z7 != z5) {
			world1.setBlockMetadataWithNotify(i2, i3, i4, i6 ^ 4);
			world1.func_28101_a((EntityPlayer)null, 1003, i2, i3, i4, 0);
		}
	}
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		if(!world1.singleplayerWorld) {
			...
			if(!world1.isBlockOpaqueCube(i7, i3, i8)) {
			...
			if(i5 > 0 && Block.blocksList[i5].canProvidePower()) {
				...
				this.func_28040_a(world1, i2, i3, i4, z9);
			}
	...
	public boolean func_28026_e(World world1, int i2, int i3, int i4, int i5) {
		if(i5 == 0) {
			...
			return world1.isBlockOpaqueCube(i2, i3, i4);
		}
	}

	public static boolean func_28038_d(int i0) {
		return (i0 & 4) != 0;
	}
}
