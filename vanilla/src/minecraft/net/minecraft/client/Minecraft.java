...
public abstract class Minecraft implements Runnable {
	...
	public void func_28003_b(UnexpectedThrowable unexpectedThrowable1) {
	...
	public void run() {
		...
		try {
			...
			this.func_28003_b(new UnexpectedThrowable("Failed to start game", exception17));
			return;
		}
		...
		try {
			...
			this.func_28003_b(new UnexpectedThrowable("Unexpected error", throwable21));
		} finally {
