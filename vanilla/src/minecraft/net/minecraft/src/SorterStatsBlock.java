...
class SorterStatsBlock implements Comparator {
	...
	public int func_27297_a(StatCrafting statCrafting1, StatCrafting statCrafting2) {
		...
		if(statBase5 != null || statBase6 != null) {
			...
			int i7 = GuiStats.func_27142_c(this.field_27298_b.field_27274_a).func_27184_a(statBase5);
			int i8 = GuiStats.func_27142_c(this.field_27298_b.field_27274_a).func_27184_a(statBase6);
			if(i7 != i8) {
