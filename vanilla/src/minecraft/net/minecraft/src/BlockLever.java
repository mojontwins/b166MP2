...
public class BlockLever extends Block {
	...
	public boolean canPlaceBlockOnSide(World world1, int i2, int i3, int i4, int i5) {
		return i5 == 1 && world1.func_28100_h(i2, i3 - 1, i4) ? true : (i5 == 2 && world1.func_28100_h(i2, i3, i4 + 1) ? true : (i5 == 3 && world1.func_28100_h(i2, i3, i4 - 1) ? true : (i5 == 4 && world1.func_28100_h(i2 + 1, i3, i4) ? true : i5 == 5 && world1.func_28100_h(i2 - 1, i3, i4))));
	}

	public boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		return world1.func_28100_h(i2 - 1, i3, i4) ? true : (world1.func_28100_h(i2 + 1, i3, i4) ? true : (world1.func_28100_h(i2, i3, i4 - 1) ? true : (world1.func_28100_h(i2, i3, i4 + 1) ? true : world1.func_28100_h(i2, i3 - 1, i4))));
	}
	...
	public void onBlockPlaced(World world1, int i2, int i3, int i4, int i5) {
		...
		i6 &= 7;
		i6 = -1;
		if(i5 == 1 && world1.func_28100_h(i2, i3 - 1, i4)) {
			i6 = 5 + world1.rand.nextInt(2);
		}

		if(i5 == 2 && world1.func_28100_h(i2, i3, i4 + 1)) {
			i6 = 4;
		}

		if(i5 == 3 && world1.func_28100_h(i2, i3, i4 - 1)) {
			i6 = 3;
		}

		if(i5 == 4 && world1.func_28100_h(i2 + 1, i3, i4)) {
			i6 = 2;
		}

		if(i5 == 5 && world1.func_28100_h(i2 - 1, i3, i4)) {
			i6 = 1;
		}
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		if(this.checkIfAttachedToBlock(world1, i2, i3, i4)) {
			...
			boolean z7 = false;
			if(!world1.func_28100_h(i2 - 1, i3, i4) && i6 == 1) {
				z7 = true;
			}

			if(!world1.func_28100_h(i2 + 1, i3, i4) && i6 == 2) {
				z7 = true;
			}

			if(!world1.func_28100_h(i2, i3, i4 - 1) && i6 == 3) {
				z7 = true;
			}

			if(!world1.func_28100_h(i2, i3, i4 + 1) && i6 == 4) {
				z7 = true;
			}

			if(!world1.func_28100_h(i2, i3 - 1, i4) && i6 == 5) {
				z7 = true;
			}

			if(!world1.func_28100_h(i2, i3 - 1, i4) && i6 == 6) {
				z7 = true;
			}
