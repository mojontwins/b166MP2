...
public class EntityArrow extends Entity {
	...
	public EntityArrow(World world1, EntityLiving entityLiving2) {
		...
		this.field_28020_a = entityLiving2 instanceof EntityPlayer;
		this.setSize(0.5F, 0.5F);
	...
	public void writeEntityToNBT(NBTTagCompound nBTTagCompound1) {
		...
		nBTTagCompound1.setBoolean("player", this.field_28020_a);
	}
	...
	public void readEntityFromNBT(NBTTagCompound nBTTagCompound1) {
		...
		this.field_28020_a = nBTTagCompound1.getBoolean("player");
	}

	public void onCollideWithPlayer(EntityPlayer entityPlayer1) {
		if(!this.worldObj.multiplayerWorld) {
			if(this.inGround && this.field_28020_a && this.arrowShake <= 0 && entityPlayer1.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1))) {
