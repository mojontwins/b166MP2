...
class SorterStatsItem implements Comparator {
	...
	public int func_27371_a(StatCrafting statCrafting1, StatCrafting statCrafting2) {
		...
		if(statBase5 != null || statBase6 != null) {
			...
			int i7 = GuiStats.func_27142_c(this.field_27372_b.field_27275_a).func_27184_a(statBase5);
			int i8 = GuiStats.func_27142_c(this.field_27372_b.field_27275_a).func_27184_a(statBase6);
			if(i7 != i8) {
