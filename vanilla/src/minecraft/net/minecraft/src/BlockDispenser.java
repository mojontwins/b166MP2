...
public class BlockDispenser extends BlockContainer {
	...
	private void dispenseItem(World world1, int i2, int i3, int i4, Random random5) {
		...
		if(itemStack12 == null) {
			...
			if(itemStack12.itemID == Item.arrow.shiftedIndex) {
				...
				entityArrow19.field_28020_a = true;
	...
	public void onBlockRemoval(World world1, int i2, int i3, int i4) {
		...
		for(int i6 = 0; i6 < tileEntityDispenser5.getSizeInventory(); ++i6) {
			...
			if(itemStack7 != null) {
				float f8 = this.field_28035_a.nextFloat() * 0.8F + 0.1F;
				float f9 = this.field_28035_a.nextFloat() * 0.8F + 0.1F;
				float f10 = this.field_28035_a.nextFloat() * 0.8F + 0.1F;

				while(itemStack7.stackSize > 0) {
					int i11 = this.field_28035_a.nextInt(21) + 10;
					...
					float f13 = 0.05F;
					entityItem12.motionX = (double)((float)this.field_28035_a.nextGaussian() * f13);
					entityItem12.motionY = (double)((float)this.field_28035_a.nextGaussian() * f13 + 0.2F);
					entityItem12.motionZ = (double)((float)this.field_28035_a.nextGaussian() * f13);
