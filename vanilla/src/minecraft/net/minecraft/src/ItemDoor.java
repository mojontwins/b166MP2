	...
	public boolean onItemUse(ItemStack itemStack1, EntityPlayer entityPlayer2, World world3, int i4, int i5, int i6, int i7) {
		if(i7 != 1) {
			...
			if(!block8.canPlaceBlockAt(world3, i4, i5, i6)) {
				...
				int i12 = (world3.func_28100_h(i4 - b10, i5, i6 - b11) ? 1 : 0) + (world3.func_28100_h(i4 - b10, i5 + 1, i6 - b11) ? 1 : 0);
				int i13 = (world3.func_28100_h(i4 + b10, i5, i6 + b11) ? 1 : 0) + (world3.func_28100_h(i4 + b10, i5 + 1, i6 + b11) ? 1 : 0);
