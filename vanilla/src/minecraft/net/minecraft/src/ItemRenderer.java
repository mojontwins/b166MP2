...
public class ItemRenderer {
	...
	public void renderItem(EntityLiving entityLiving1, ItemStack itemStack2) {
		...
		if(itemStack2.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[itemStack2.itemID].getRenderType())) {
			...
			this.renderBlocksInstance.renderBlockOnInventory(Block.blocksList[itemStack2.itemID], itemStack2.getItemDamage());
		} else {
	...
	public void renderItemInFirstPerson(float f1) {
		...
		GL11.glPopMatrix();
		float f5 = this.mc.theWorld.getLightBrightness(MathHelper.floor_double(entityPlayerSP3.posX), MathHelper.floor_double(entityPlayerSP3.posY), MathHelper.floor_double(entityPlayerSP3.posZ));
		GL11.glColor4f(f5, f5, f5, 1.0F);
		ItemStack itemStack6 = this.itemToRender;
		float f7;
		float f8;
		float f9;
		float f10;
		if(itemStack6 != null && itemStack6.itemID == Item.mapItem.shiftedIndex) {
			GL11.glPushMatrix();
			f7 = 0.8F;
			...
			GL11.glTranslatef(0.0F, 0.0F * f7 - (1.0F - f2) * 1.2F - f8 * 0.5F + 0.04F, -0.9F * f7);
			...
			for(int i16 = 0; i16 < 2; ++i16) {
				int i19 = i16 * 2 - 1;
				GL11.glPushMatrix();
				GL11.glTranslatef(-0.0F, -0.6F, 1.1F * (float)i19);
				GL11.glRotatef((float)(-45 * i19), 1.0F, 0.0F, 0.0F);
				GL11.glRotatef(-90.0F, 0.0F, 0.0F, 1.0F);
				GL11.glRotatef(59.0F, 0.0F, 0.0F, 1.0F);
				GL11.glRotatef((float)(-65 * i19), 0.0F, 1.0F, 0.0F);
			...
			float f17 = MathHelper.sin(MathHelper.sqrt_float(f9) * (float)Math.PI);
			...
			byte b20 = 7;
			tessellator18.addVertexWithUV((double)(0 - b20), (double)(128 + b20), 0.0D, 0.0D, 1.0D);
			tessellator18.addVertexWithUV((double)(128 + b20), (double)(128 + b20), 0.0D, 1.0D, 1.0D);
			tessellator18.addVertexWithUV((double)(128 + b20), (double)(0 - b20), 0.0D, 1.0D, 0.0D);
			tessellator18.addVertexWithUV((double)(0 - b20), (double)(0 - b20), 0.0D, 0.0D, 0.0D);
			tessellator18.draw();
			MapData mapData21 = Item.mapItem.func_28012_a(itemStack6, this.mc.theWorld);
			this.field_28131_f.func_28157_a(this.mc.thePlayer, this.mc.renderEngine, mapData21);
			GL11.glPopMatrix();
			...
			if(itemStack6.getItem().shouldRotateAroundWhenRendering()) {
				GL11.glRotatef(180.0F, 0.0F, 1.0F, 0.0F);
			}

			this.renderItem(entityPlayerSP3, itemStack6);
			GL11.glPopMatrix();
		} else {
			GL11.glPushMatrix();
			f7 = 0.8F;
			...
			Render render14 = RenderManager.instance.getEntityRenderObject(this.mc.thePlayer);
			RenderPlayer renderPlayer15 = (RenderPlayer)render14;
			f10 = 1.0F;
			GL11.glScalef(f10, f10, f10);
			renderPlayer15.drawFirstPersonHand();
			GL11.glPopMatrix();
		}
	...
	public void renderOverlays(float f1) {
		...
		if(this.mc.thePlayer.isEntityInsideOpaqueBlock()) {
			...
			if(this.mc.theWorld.func_28100_h(i2, i3, i4)) {
				...
				for(int i7 = 0; i7 < 8; ++i7) {
					...
					if(this.mc.theWorld.func_28100_h(i11, i12, i13)) {
