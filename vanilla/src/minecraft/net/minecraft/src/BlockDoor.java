...
public class BlockDoor extends Block {
	...
	public void openDoor(World world1, int i2, int i3, int i4, boolean z5) {
		int i6 = world1.getBlockMetadata(i2, i3, i4);
		if((i6 & 8) != 0) {
			if(world1.getBlockId(i2, i3 - 1, i4) == this.blockID) {
				this.openDoor(world1, i2, i3 - 1, i4, z5);
			}
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		...
		if((i6 & 8) != 0) {
			...
			if(!world1.func_28100_h(i2, i3 - 1, i4)) {
				world1.setBlockWithNotify(i2, i3, i4, 0);
				z7 = true;
				if(world1.getBlockId(i2, i3 + 1, i4) == this.blockID) {
			...
			if(z7) {
				...
				this.openDoor(world1, i2, i3, i4, z8);
			}
		}
	...
	public boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		return i3 >= 127 ? false : world1.func_28100_h(i2, i3 - 1, i4) && super.canPlaceBlockAt(world1, i2, i3, i4) && super.canPlaceBlockAt(world1, i2, i3 + 1, i4);
	}
