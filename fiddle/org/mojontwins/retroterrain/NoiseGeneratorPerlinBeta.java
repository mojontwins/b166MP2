...
public class NoiseGeneratorPerlinBeta extends NoiseGenerator {
	...
	public NoiseGeneratorPerlinBeta(Random random1) {
	...
	public final double grad(int i1, double d2, double d4) {
		int i6 = i1 & 15;
		...
		if(i9 == 1) {
			...
			for(int i30 = 0; i30 < i8; ++i30) {
				...
				for(i37 = 0; i37 < i10; ++i37) {
					...
					d70 = this.lerp(d35, this.grad(this.permutations[i66], d31, d38), this.grad(this.permutations[i22], d31 - 1.0D, 0.0D, d38));
