...
public class NoiseGeneratorOctavesAlpha extends NoiseGenerator {
	...
	public NoiseGeneratorOctavesAlpha(Random random, int octaves) {
		this.octaves = octaves;
		this.generatorCollection = new NoiseGeneratorPerlinAlpha[octaves];

		for(int i3 = 0; i3 < octaves; ++i3) {
			this.generatorCollection[i3] = new NoiseGeneratorPerlinAlpha(random);
		}
